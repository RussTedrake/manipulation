...
class TestPhysicsSimulationDiagramStructure(unittest.TestCase):
    ...
    def test_create_IIWA14_diagram_structure(self):
        ...
        self.assertIsInstance(iiwa, ModelInstanceIndex, "Should return a ModelInstanceIndex")
...
class TestPhysicsSimulationSimpleController(unittest.TestCase):
    ...
    def test_simple_controller_computation(self):
        ...
        controller = SimpleController(gain=10.0, q_desired=np.array([1, 1, 0, 0, 0, 0, 0]))
...
class TestPhysicsSimulationVerification(unittest.TestCase):
    ...
    def test_gradescope_verification(self):
        ...
        simulate_IIWA14_with_controller = self.notebook_locals["simulate_IIWA14_with_controller"]
        ...
        expected_q_final = np.array([
            1.26317171e-02, 8.13040566e-03, -5.72823579e-02, -2.43876159e-02,
            -1.37802794e-04, 4.71369969e-04, -2.97584254e-05
        ])

        self.assertEqual(len(q_final), 7, "Should return 7 joint positions")
        self.assertTrue(np.all(np.isfinite(q_final)), "All joint positions should be finite")
        self.assertTrue(
