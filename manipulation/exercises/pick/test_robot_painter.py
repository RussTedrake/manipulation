...
import numpy as np
from pydrake.all import PiecewiseQuaternionSlerp, PiecewisePolynomial, ToleranceType
...
class TestRobotPainter(unittest.TestCase):
    ...
    def test_trajectories(self):
        ...
        self.assertTrue(traj_wG_true.isApprox(traj_w_G_test, tol=1e-3, tol_type=ToleranceType.absolute))
        self.assertTrue(traj_vG_true.isApprox(traj_v_G_test, tol=1e-3, tol_type=ToleranceType.absolute))